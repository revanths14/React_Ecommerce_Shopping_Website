...
export default function Sidebar() {
  ...
  return (
    ...
    duration-300 z-20 px-4 lg:px-[35px] uppercase text-sm font-semibold`}>
      ...
      <div className='' >
        ...
        overflow-x-hidden border-b' style={{height:"400px" ,overflowY:"scroll",overflowX:"hidden"}}>
        {cart.map((item)=>{
      ...
      mt-4'>
        <div className='flex w-full justify-between items-center'>
          ...
          {/* {clear cart icon} */}
          <div onClick={clearCart} className='cursor-pointer py-4 bg-blue-500
